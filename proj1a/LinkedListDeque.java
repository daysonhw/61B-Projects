public class LinkedListDeque<T> implements LLDInterface {
    private static class DLLNode<T> {
        private T element;
        private DLLNode<Object> prev;
        private DLLNode<Object> next;

        public DLLNode(T e, DLLNode<Object> p, DLLNode<Object> n) {
            element = e;
            prev = p;
            next = n;
        }
